...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		var projectName = "OpenFL installer";
		
		var config = {
			
			build: "289",
			company: "",
			file: "OpenFL installer",
			fps: 20,
			name: "OpenFL Installer",
			orientation: "",
			packageName: "OpenFL Installer",
			version: "1.0.0",
			windows: [
		...
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed (projectName, null, 600, 300, config);
		#end
		#else
		create (config);
		#end
